...
class View:
    ...
    font_path = base_path.joinpath("resources/fonts")
    ...
    print(str(font_path.joinpath('Assistant-Medium.ttf')))
    ASSISTANT16 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 16)
    ASSISTANT18 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 18)
    ASSISTANT20 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 20)
    ASSISTANT21 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 21)
    ASSISTANT22 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 22)
    ASSISTANT23 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 23)
    ASSISTANT25 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 25)
    ASSISTANT26 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 26)
    ASSISTANT35 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 35)
    ASSISTANT50 = ImageFont.truetype(str(font_path.joinpath('Assistant-Medium.ttf')), 50)
    ASSISTANT16BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 15)
    ASSISTANT18BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 17)
    ASSISTANT20BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 19)
    ASSISTANT21BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 20)
    ASSISTANT22BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 21)
    ASSISTANT23BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 22)
    ASSISTANT25BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 25)
    ASSISTANT26BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 26)
    ASSISTANT35BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 35)
    ASSISTANT50BOLD = ImageFont.truetype(str(font_path.joinpath('Assistant-Bold.ttf')), 50)
    ROBOTOMONO14 = ImageFont.truetype(str(font_path.joinpath('RobotoMono-Medium.ttf')), 14)
    ROBOTOMONO24 = ImageFont.truetype(str(font_path.joinpath('RobotoMono-Medium.ttf')), 24)
    ROBOTOMONO38 = ImageFont.truetype(str(font_path.joinpath('RobotoMono-Medium.ttf')), 38)
    ROBOTOMONO30 = ImageFont.truetype(str(font_path.joinpath('RobotoMono-Medium.ttf')), 30)
    ROBOTOMONO20 = ImageFont.truetype(str(font_path.joinpath('RobotoMono-Medium.ttf')), 20)

    ROBOTOCONDENSED_BOLD_16 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 16)
    ROBOTOCONDENSED_BOLD_18 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 18)
    ROBOTOCONDENSED_BOLD_20 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 20)
    ROBOTOCONDENSED_BOLD_22 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 20)
    ROBOTOCONDENSED_BOLD_24 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 22)
    ROBOTOCONDENSED_BOLD_25 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 25)
    ROBOTOCONDENSED_BOLD_26 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 26)
    ROBOTOCONDENSED_BOLD_28 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Bold.ttf")), 28)
    ROBOTOCONDENSED_LIGHT_16 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Light.ttf")), 16)
    ROBOTOCONDENSED_LIGHT_24 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Light.ttf")), 24)
    ROBOTOCONDENSED_REGULAR_16 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 16)
    ROBOTOCONDENSED_REGULAR_20 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 20)
    ROBOTOCONDENSED_REGULAR_22 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 22)
    ROBOTOCONDENSED_REGULAR_24 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 24)
    ROBOTOCONDENSED_REGULAR_26 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 26)
    ROBOTOCONDENSED_REGULAR_28 = ImageFont.truetype(str(font_path.joinpath("RobotoCondensed-Regular.ttf")), 28)
